...
module.exports = {
    ...
    SESSION: process.env.SPIRITSER_CODE === undefined ? '' : process.env.SPIRITSER_CODE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By spiritser' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://www.linkpicture.com/q/IMG-20220330-WA0104.png' : process.env.LG_LOGO,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ sᴘɪʀɪᴛ sᴇʀ  ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'SPIRIT SER ' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/IMG-20220330-WA0104.png' : process.env.ALL_IMG,
